#!/usr/bin/env sh
# Universal installer for pincheck. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/pincheck.git"
echo "Installing pincheck ..."
