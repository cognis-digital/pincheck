...
- Niche focus: Teams configure pinning then ship apps where it silently fails; pincheck is a deterministic pass/fail CI gate proving pinning works against a rogue cert — closes a gap nothing else automates..
