"""Native cognis-connect emit for pincheck — forward findings to any platform.

Maps pincheck's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    pincheck ... --format json | pincheck-emit --to stix
    pincheck-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
